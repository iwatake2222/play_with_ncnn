...
#define MODEL_NAME  "ufldv2_culane_res18_320x1600.param"
#define INPUT_DIMS  { 1, 3, 320, 1600 }
#elif defined(USE_TUSIMPLE)
#define MODEL_NAME  "ufldv2_tusimple_res18_320x800.param"
#define INPUT_DIMS  { 1, 3, 320, 800 }
#elif defined(USE_CULANECURVELANES)
#define MODEL_NAME  "ufldv2_curvelanes_res18_800x1600.param"
